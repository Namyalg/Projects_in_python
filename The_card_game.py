...
def level(count):
        ...
        text = font.render('LEVEL ' + str(count+1) , True, white, (0,0,0)) 
        textRect = text.get_rect() 
...
def intro():
        ...
        text = font.render('cUmHaChT' , True, white, (0,0,0)) 
        textRect = text.get_rect() 
        textRect.center = (196,200 )
        display_surface.blit(text , textRect)
        font = pygame.font.Font('freesansbold.ttf', 72) 
        text = font.render('CuImHnE ' , True, white, (0,0,0)) 
        textRect = text.get_rect() 
...
def d(count):
    ...
    while running:
        ...
        text = smallfont.render('Number on card ' + str(index) + ' ?' , False, (0,0,0)) 
        textRect = text.get_rect() 
        textRect.center = (200,100)
